...
local Elementsx = function(Title, Desc, Parent, Hover)
	local Element = {}
...
local ProtectGui = protectguin or (syn and syn.protect_gui) or (gethui and function(gui) gui.Parent = gethui()end) or function() end
